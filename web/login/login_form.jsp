    ...
    <h:outputStylesheet library="css" name="/resources/css/login.css"/>
       ...
       <div class="circle light"></div>
        ...
        <form method="post" action="j_security_check">
            <p>Cedula : <input type="text" name="j_username" value="10881" placeholder="cedula" required="required"></p>
            <p>Contraseña: <input type="password" name="j_password" value="123" placeholder="*****" required="required"> </p>           
